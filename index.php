        ...
        <div class="hero_container">
          <div class="text_section">
            ...
            <div class="hero_section_button">
             <a href="order.php"><button class="button">Order Online</button></a>
             <a href="book.php"><button class="button">Book A Table</button></a>
            </div>
          </div>
        ...
        <div class="footer_section">
          ...
          <div class="contact_us">
            ...
            <ul>
              <li>
                <i class="bx bx-current-location"></i>
                <span>Pachora, Jalgoan</span>
              </li>
              <li>
                <i class="bx bxs-phone-call"></i> <span>+91 9156462024</span>
              </li>
              <li>
                <i class="bx bxs-time-five"></i>
